...
function App() {
  ...
  const vision = "Reviving the elects through the word of possibilities, anointing and edification in Christ Jesus through the instrumentality of Global missions and sending missionaries to all nations of the earth and into all works of life for the full redemption of the total man unto dignity in Christ. \nEquipping the called for his calling; making him an apostolic vessel God can use through the establishing of ministerial and leadership institutions for the raising and empowering of kingdom giants for the fulfilments of their apostolic and global callings across the seven (7) world continents."
  ...
  return (
    ...
    <div className="mx-auto">
      ...
      {/* EVENTS SECTION */}
      {/* ABOUT SECTION */}
      <AboutSection title="About" mission={mission} vision={vision} images={images}/>
