...
const Connect: React.FC<ConnectProps> = ({ bgColor }) => {
    ...
    return (
      <div className="relative inline-block mt-6">
        <button
          onClick={togglePopup}
          className={`${bgColor} hover:${bgColor} transition-colors duration-300 text-white px-8 py-3 rounded-lg flex items-center justify-center gap-4 w-[280px] shadow-md`}
        >
        ...
        {showPopup && (
          <>
            <div className="fixed inset-0" onClick={togglePopup} />
